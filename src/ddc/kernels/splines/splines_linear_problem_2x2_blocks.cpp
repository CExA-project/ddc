...
struct SplinesLinearProblem2x2Blocks<ExecSpace>::Coo
{
    ...
    KOKKOS_FUNCTION Kokkos::View<int*, Kokkos::LayoutRight, memory_space> rows_idx() const
    {
        return m_rows_idx;
    }

    KOKKOS_FUNCTION Kokkos::View<int*, Kokkos::LayoutRight, memory_space> cols_idx() const
    {
        return m_cols_idx;
    }
