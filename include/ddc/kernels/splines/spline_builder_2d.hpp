...
public:
     ...
     * @param cols_per_chunk A hyperparameter used by the slicer (internal to the solver) to define
	 * the size of a chunk of right-and-sides of the linear problem to be computed in parallel.
     * @param preconditionner_max_block_size A hyperparameter used by the slicer (internal to the solver)
	 * to define the size of a block used by the Block-Jacobi preconditioner.
     *
     * @see MatrixSparse
     */
