...
TEST(FFTHost, R2C_1D)
{
    test_fft<Kokkos::DefaultHostExecutionSpace, Kokkos::DefaultHostExecutionSpace::memory_space, float, Kokkos::complex<float>, RDimX>();
}
