...
SplinesLinearProblemPDSBand::SplinesLinearProblemPDSBand(
...
SplinesLinearProblemPDSBand::~SplinesLinearProblemPDSBand() = default;

double SplinesLinearProblemPDSBand::get_element(std::size_t i, std::size_t j) const
{
    assert(i < size());
    assert(j < size());
...
void SplinesLinearProblemPDSBand::set_element(std::size_t i, std::size_t j, double const aij)
{
    assert(i < size());
    assert(j < size());
...
void SplinesLinearProblemPDSBand::setup_solver()
{
...
void SplinesLinearProblemPDSBand::solve(MultiRHS const b, bool const) const
{
