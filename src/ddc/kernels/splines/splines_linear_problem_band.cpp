...
SplinesLinearProblemBand<ExecSpace>::SplinesLinearProblemBand(
...
template <class ExecSpace>
void SplinesLinearProblemBand<ExecSpace>::solve(MultiRHS const b, bool const transpose) const
{
        ...
        Kokkos::parallel_for(
                ...
                KOKKOS_LAMBDA(int const i) {
                    ...
                    KokkosBatched::SerialGbtrs<
                            ...
                            invoke(q_device, ipiv_device, sub_b, kl_proxy, ku_proxy);
                });
    } else {
        Kokkos::parallel_for(
                "gbtrs",
...
template class SplinesLinearProblemBand<Kokkos::Serial>;
#endif
#if defined(KOKKOS_ENABLE_OPENMP)
template class SplinesLinearProblemBand<Kokkos::OpenMP>;
#endif
#if defined(KOKKOS_ENABLE_CUDA)
template class SplinesLinearProblemBand<Kokkos::Cuda>;
#endif
#if defined(KOKKOS_ENABLE_HIP)
template class SplinesLinearProblemBand<Kokkos::HIP>;
#endif
#if defined(KOKKOS_ENABLE_SYCL)
template class SplinesLinearProblemBand<Kokkos::SYCL>;
#endif
