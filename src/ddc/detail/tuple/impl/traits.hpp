...
template <class U>
struct is_empty_copy_list_initializable_helper<U, std::void_t<decltype(U({}))>> : std::true_type
{
};
...
struct is_empty_copy_list_initializable
{
    ...
    static constexpr bool value = is_empty_copy_list_initializable_helper<helper>::value;
};
...
{
    static constexpr bool value = !std::is_same_v<std::remove_cvref_t<T>, std::remove_cvref_t<U>>;
};
...
template <class T, class U>
struct reference_constructs_from_temporary<T const&, U>
              ...
              (std::is_same_v<std::remove_cvref_t<T>, std::remove_cvref_t<U>>
               && !std::is_reference_v<U>)
                      || (std::conjunction_v<
                              ...
                              std::is_convertible<
                                      std::conditional_t<
                                              std::is_scalar_v<U> || std::is_void_v<U>,
                                              std::remove_cv_t<U>,
                                              U>,
                                      T>>)>
{
...
{
    using type = cexa::tuple<std::common_reference_t<
            TQual<std::tuple_element_t<Ints, TTuple>>,
...
{
    using type = cexa::tuple<std::common_type_t<
            std::tuple_element_t<Ints, TTuple>,
...
{
    static_assert(std::is_same_v<cexa::tuple<TTypes...>, std::decay_t<cexa::tuple<TTypes...>>>);
...
template <class TTuple, class... UTypes, template <class> class TQual, template <class> class UQual>
struct std::basic_common_reference<TTuple, cexa::tuple<UTypes...>, TQual, UQual>
{
