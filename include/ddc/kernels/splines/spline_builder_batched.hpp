...
/******************************************************************
    ...
    *******************************************************************/
    ...
    ddc::for_each(spline_basis_domain, [&](ddc::DiscreteElement<bsplines_type1> const i) {
        ...
        const std::optional<ddc::CDSpan1D> deriv_l(
                BcXmin2 == ddc::BoundCond::HERMITE ? std::optional(l_derivs.allocation_mdspan())
                                              : std::nullopt);
        const std::optional<ddc::CDSpan1D> deriv_r(
                BcXmax2 == ddc::BoundCond::HERMITE ? std::optional(r_derivs.allocation_mdspan())
                                              : std::nullopt);
