...
public:
    ...
    void operator()([[maybe_unused]] index_type<0> unused_id, typename Reducer::value_type& a) const
    {
    ...
    template <std::size_t N = sizeof...(Idx), std::enable_if_t<(N > 0), bool> = true>
    void operator()(index_type<Idx>... ids, typename Reducer::value_type& a) const
    {
