...
public:
     ...
     */
    void spdm_minus1_1(Coo const& LinOp, MultiRHS x, MultiRHS y, bool transpose = false) const;
...
extern template class SplinesLinearProblem2x2Blocks<Kokkos::Serial>;
#endif
#if defined(KOKKOS_ENABLE_OPENMP)
extern template class SplinesLinearProblem2x2Blocks<Kokkos::OpenMP>;
#endif
#if defined(KOKKOS_ENABLE_CUDA)
extern template class SplinesLinearProblem2x2Blocks<Kokkos::Cuda>;
#endif
#if defined(KOKKOS_ENABLE_HIP)
extern template class SplinesLinearProblem2x2Blocks<Kokkos::HIP>;
#endif
#if defined(KOKKOS_ENABLE_SYCL)
extern template class SplinesLinearProblem2x2Blocks<Kokkos::SYCL>;
#endif
