...
SplinesLinearProblemPDSTridiag::SplinesLinearProblemPDSTridiag(std::size_t const mat_size)
...
SplinesLinearProblemPDSTridiag::~SplinesLinearProblemPDSTridiag() = default;

double SplinesLinearProblemPDSTridiag::get_element(std::size_t i, std::size_t j) const
{
    assert(i < size());
    assert(j < size());
...
void SplinesLinearProblemPDSTridiag::set_element(std::size_t i, std::size_t j, double const aij)
{
    assert(i < size());
    assert(j < size());
...
void SplinesLinearProblemPDSTridiag::setup_solver()
{
...
void SplinesLinearProblemPDSTridiag::solve(MultiRHS const b, bool const) const
{
