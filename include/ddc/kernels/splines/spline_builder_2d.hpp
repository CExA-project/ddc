...
public:
    ...
    static constexpr ddc::BoundCond BcXmin1 = SplineBuilder1::s_bc_xmin;
    static constexpr ddc::BoundCond BcXmax1 = SplineBuilder1::s_bc_xmax;
    static constexpr ddc::BoundCond BcXmin2 = SplineBuilder2::s_bc_xmin;
    static constexpr ddc::BoundCond BcXmax2 = SplineBuilder2::s_bc_xmax;
...
public:
    ...
    void operator()(
            ddc::ChunkSpan<
                    double,
                    ddc::DiscreteDomain<bsplines_type1, bsplines_type2>,
                    Layout1,
                    MemorySpace> spline,
            ddc::ChunkSpan<double const, interpolation_domain_type, Layout2, MemorySpace> vals,
            std::optional<ddc::CDSpan2D> const derivs_xmin = std::nullopt,
            std::optional<ddc::CDSpan2D> const derivs_xmax = std::nullopt,
            std::optional<ddc::CDSpan2D> const derivs_ymin = std::nullopt,
            std::optional<ddc::CDSpan2D> const derivs_ymax = std::nullopt,
            std::optional<ddc::CDSpan2D> const mixed_derivs_xmin_ymin = std::nullopt,
            std::optional<ddc::CDSpan2D> const mixed_derivs_xmax_ymin = std::nullopt,
            std::optional<ddc::CDSpan2D> const mixed_derivs_xmin_ymax = std::nullopt,
            std::optional<ddc::CDSpan2D> const mixed_derivs_xmax_ymax = std::nullopt) const;
...
void SplineBuilder2D<SplineBuilder1, SplineBuilder2>::operator()(
        ddc::ChunkSpan<
                ...
                MemorySpace> spline,
        ddc::ChunkSpan<double const, interpolation_domain_type, Layout2, MemorySpace> vals,
        std::optional<ddc::CDSpan2D> const derivs_xmin,
        std::optional<ddc::CDSpan2D> const derivs_xmax,
        std::optional<ddc::CDSpan2D> const derivs_ymin,
        std::optional<ddc::CDSpan2D> const derivs_ymax,
        std::optional<ddc::CDSpan2D> const mixed_derivs_xmin_ymin,
        std::optional<ddc::CDSpan2D> const mixed_derivs_xmax_ymin,
        std::optional<ddc::CDSpan2D> const mixed_derivs_xmin_ymax,
        std::optional<ddc::CDSpan2D> const mixed_derivs_xmax_ymax) const
{
