...
TEST(DiscreteElementXTest, RightExternalBinaryOperatorPlus)
{
    ...
    EXPECT_EQ(ix2.uid<DDimX>(), static_cast<std::ptrdiff_t>(uid_x) + dv_x);
}
...
TEST(DiscreteElementXTest, RightExternalBinaryOperatorMinus)
{
    ...
    EXPECT_EQ(ixy2.uid<DDimX>(), static_cast<std::ptrdiff_t>(uid_x) - dv_x);
}
...
TEST(DiscreteElementXYTest, RightExternalBinaryOperatorPlus)
{
    ...
    EXPECT_EQ(ixy2.uid<DDimX>(), static_cast<std::ptrdiff_t>(uid_x) + dv_x);
    EXPECT_EQ(ixy2.uid<DDimY>(), static_cast<std::ptrdiff_t>(uid_y) + dv_y);
}
...
TEST(DiscreteElementXYZTest, RightExternalBinaryOperatorPlus)
{
    ...
    EXPECT_EQ(ixyz2.uid<DDimX>(), static_cast<std::ptrdiff_t>(uid_x) + dv_x);
    EXPECT_EQ(ixyz2.uid<DDimY>(), static_cast<std::ptrdiff_t>(uid_y) + dv_y);
